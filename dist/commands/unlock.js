        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return channel.permissionOverwrites.edit(role.id, { SendMessages: true })
                ...
                if (interaction.options.getChannel('role'))
                    return interaction.reply({
                        embeds: [(0, replacerArray_1.replaceEmbed)(this.embeds.unlocked_role, ['{channel}', '{role}'], [channel.toString(), role.toString()])]
                    });
                else
                    return interaction.reply({
                        embeds: [(0, replacerArray_1.replaceEmbed)(this.embeds.unlocked_everyone, ['{channel}'], [channel.toString()])]
                    });
            })
                .catch(() => {
                return interaction.reply({
