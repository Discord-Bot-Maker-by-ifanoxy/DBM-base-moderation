...
exports.default = {
    ...
    builder: new discord_js_1.SlashCommandBuilder()
        ...
        .setDefaultMemberPermissions(discord_js_1.PermissionsBitField.Flags.KickMembers)
    ...
    execute(client, interaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield targetMember.kick(reason);
            return interaction.reply({
                embeds: [(0, replacerArray_1.replaceEmbed)(this.embeds.kicked, ['{member}', '{reason}'], [targetMember.toString(), reason !== null && reason !== void 0 ? reason : 'No reason provided'])]
            });
        });
    }
};
